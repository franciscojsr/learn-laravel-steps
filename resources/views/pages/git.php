<div><h1>Some Git commands<?php if(Request::path()!="git_using"){echo'<a href="#"><img class="simbol"></a>';} ?></h1><small class="lobster">Learn more about --> <a href="http://git-scm.com/doc" target="_blank">git documentation</a></small></div>
