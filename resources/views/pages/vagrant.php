<div><h1>VM Homestead Vagrant<?php if(Request::path()!="vagrant_vm"){echo'<a href="#"><img class="simbol"></a>';} ?></h1><small class="lobster">Learn more about --> <a href="http://laravel.com/docs/4.2/homestead" target="_blank">Laravel homestead</a></small></div>
