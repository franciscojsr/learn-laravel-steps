<div><h1>Install Laravel<?php if(Request::path()!="laravel_install"){echo'<a href="#"><img class="simbol"></a>';} ?></h1><small class="lobster">Learn more about --> <a href="http://laravel.com" target="_blank">Laravel</a> </small></div>
